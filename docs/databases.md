...
- [04-pod-monitor.yaml](../03-airgap-zone/manifests/cnpg/04-pod-monitor.yaml)
- [05-grafana-dashboard.yaml](../03-airgap-zone/manifests/cnpg/05-grafana-dashboard.yaml)
